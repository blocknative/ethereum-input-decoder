...
test('decoder', (t) => {
  ...
  //   const result = decoder.decodeData(data)
  //   const expectedSetApprovalForAll = {
  ...
  t.test('Seaport 1.1', (t) => {
    t.plan(1)
    const decoder = new InputDataDecoder(`${__dirname}/data/seaport_abi.json`)
    const data = ''
    const result = decoder.decodeData(data)
    console.log(JSON.stringify(result, null, 2))
    // looking for a method name: fulfillAdvancedOrder
    // const expectedfulfillAdvancedOrder = {
    //   "methodName": "idk yet",
    //   "params": {
    //     "stringName": "butt"
    //   }
