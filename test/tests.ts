...
test('decoder', (t) => {
  ...
  // t.test('Uniswap V3: Swap router, function testing', (t) => {
  //   t.plan(1)

  //   const decoder = new InputDataDecoder(`${__dirname}/data/uniswap_v3_swap_router.json`)
  //   const data = ''
  //   const result = decoder.decodeData(data)
  //   const expectedSetApprovalForAll = {}
  //   t.deepEquals(result, result)
  // })

  // t.test('Deposit for erc20 call test', (t) => {
  //   t.plan(1)

  //   const decoder = new InputDataDecoder(`${__dirname}/data/erc20_abi.json`)
  ...
  // t.test('Check this weird uni v3 input', (t) => {
  //   t.plan(1)
  //   const decoder = new InputDataDecoder(`${__dirname}/data/uniswap_v3_swap_router.json`)
  //   const data = ''
  //   const result = decoder.decodeData(data)
  //   console.log('\nResponse:\n')
  //   console.log(JSON.stringify(result, 0, 2))
  //   const expectedSetApprovalForAll = {}
  ...
  t.test('uniswap v3 router 2 multicall tests', (t) => {
    t.plan(1)
    const decoder = new InputDataDecoder(`${__dirname}/data/uniswap-v3-router-2.json`)
    const data = '0x49404b7c0000000000000000000000000000000000000000000000004a3b8d62d1e68a13000000000000000000000000f5afad56a17cbb0c1eeba4d0d7c7278b7564c0fa'
    const result = decoder.decodeData(data)
    console.log('\nResponse:\n')
    console.log(JSON.stringify(result, 0, 2))
    const expectedSetApprovalForAll = {}
